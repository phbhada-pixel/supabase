...
async function fetchReportData() {
    ...
    if (periodType === 'monthly') {
        ...
        if (dyDiv && !dyDiv.classList.contains('hidden')) {
            ...
            // 🟢 बदल: अहवालावर 'तारीख 2' ऐवजी थेट '02-07-2026' अशी पूर्ण तारीख दिसेल.
    ...
    try {
        ...
        if(finalReports.length > 0) { 
            ...
            alert(`⚠️ तुम्ही निवडलेल्या कालावधीचा डेटा फिल्टरमुळे लपवला जात आहे.\n\nकृपया खात्री करा की तुम्ही निवडलेले 'उपकेंद्र', 'वर्ष' आणि 'तारीख' अचूक आहेत.`); 
        }
